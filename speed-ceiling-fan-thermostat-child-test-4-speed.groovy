/*
   Virtual Thermostat for Speed Ceiling Fan Control
 ...
 */
definition(
    name: "SpeedCeilingFanThermostatChild",
    ...
    category: "My Apps",
    parent: "Speed Ceiling Fan Thermostat:Speed Ceiling Fan Thermostat",
...
def childStartPage() {
	dynamicPage(name: "childStartPage", title: "Select your devices and settings", install: true, uninstall: true) {
        ...
        section("Optional Settings (Diff Temp, Timers, Motion, etc)") {
        	...
        	description: none,
        	image: "https://raw.githubusercontent.com/Welasco/SmartthingsFanControlHubitat/master/settings250x250.png",
        	required: false,
        	page: "optionsPage"
        	)
        }
...
// VERSION
			href (name: "aboutPage", 
			title: "Speed Ceiling Fan Thermostat \n"+"Version:1.10172020 \n"+"Copyright © 2020 Victor Santana", 
			description: "Tap to get user's guide.",
			image: "https://raw.githubusercontent.com/Welasco/SmartthingsFanControlHubitat/master/3scft125x125.png",
			required: false,
			page: "aboutPage"
			)
		}
...
def aboutPage() {
	dynamicPage(name: "aboutPage", title: none, install: true, uninstall: true) {
     	section("User's Guide; Speed Ceiling Fan Thermostat") {
        	paragraph textHelp()
 		}
	}
}
